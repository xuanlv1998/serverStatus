...
GITHUB_RAW_URL = "https://raw.githubusercontent.com/xuanlv1998/serverStatus/master"
GITEE_RAW_URL = "https://gitee.com/xuanlv1998/server-status/raw/master/"
...
def how2agent(user, passwd):
    ...
    print("\n")
    print(
        'curl -L {0}/sss-agent.sh  -o sss-agent.sh && chmod +x sss-agent.sh && sudo ./sss-agent.sh {1} {2} {3}'.format(
            GITHUB_RAW_URL, getIP(), user, passwd))
    print("\n")
    print('```')
